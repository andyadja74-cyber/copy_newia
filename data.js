...
module.exports = {
  ...
  REPONSES_8BALL: [
    ...
    "Ma réponse est non. ❌",
    "C'est un secret que je ne peux révéler. 🤫",
    "La boule est floue, redemande plus tard ! 🌫️",
    "Si tu y crois vraiment, alors oui. 💫",
    "Impossible ! 🚫"
  ],

  // 🤥 DÉTECTEUR DE MENSONGES
  VERDICTS_MENSONGE: [
    "100% VRAI ! Même le Créateur n'aurait pas fait mieux 👑",
    "Gros gros mensonge ! Ton nez vient de s'allonger de 3 kilomètres 🤥",
    "Du pipeau total ! Arrête un peu de mentir au peuple 😭",
    "C'est du 50/50 : mi-vérité, mi-gros mytho 🎭",
    "Vrai à 95% ! On peut fermer les yeux et valider ✅",
    "Attention, alerte au mytho de l'année ! 🚨"
  ],  
  ...
  COMMENTAIRES_LOVE: {
    parfait: [
      ...
      "Même Cupidon est jaloux de vous deux ! 💘",
      "Vous respirez l'amour pur ! 🔥"
    ],
    moyen: [
      "Il y a un potentiel ! 🙂", 
      "Alors 😌 c'est bien ça 😏", 
      "À travailler avec le temps ! ⏳",
      "Un petit effort et ce sera parfait ! 🤝",
      "Il y a une petite flamme à raviver. 🕯️"
    ],
    faible: [
      "L'amitié c'est bien aussi hyn... 🤣", 
      "Aïe, purée mal fait dehhh 🤣💔", 
      "je la ferme ohh 💔🤣🫢😌",
      "Fuyez pendant qu'il est encore temps ! 🏃‍♂️💨",
      "C'est un match éclaté au sol 🥶"
    ]
  },
  CONSEILS_LOVE: [
    ...
    "Soyez à l'écoute, les détails comptent plus que les cadeaux. 👂",
    "Un peu d'humour désamorce les plus grandes disputes ! 😂"
  ],
  ...
  LISTE_ANIMAUX: [
    ...
    { nom: "Loup", type: "sauvage", nourriture: "gibier" },
    { nom: "Pingouin", type: "oiseau", nourriture: "glaçons au poisson" }
  ],
  ...
  DONNEES_CERVEAU: [
    ...
    "🤡 Potentiel comique",
    "📈 Chance de survie sans Google"
  ],

  // 💘 PHRASES DE DRAGUE
  LISTE_DRAGUES: [
    "Hé @tag 😏 t'as un pansement? Parce que je me suis fait mal en tombant amoureux de toi",
    "@tag, t'es pas Google par hasard? Parce que t'as tout ce que je cherche",
    "Si j'étais une lettre de l'alphabet, je serais le U et toi le I, parce qu'on ferait UI ensemble",
    "@tag ton prénom doit être WiFi, parce que je capte une connexion entre nous",
    "T'es fatiguée? Parce que t'as tourné dans ma tête toute la journée @tag",
    "Excuse moi @tag, t'aurais pas l'heure? En fait non j'ai juste besoin de ton numéro",
    "On dirait que t'as perdu un truc @tag... Ah non c'est mon coeur, tu l'as volé",
    "@tag si la beauté était un crime, tu prendrais perpète",
    "Même si j'avais une carte du monde, je serais toujours perdu dans ton regard @tag",
    "Bon @tag avoue, t'es magique? Parce qu'à chaque fois que je te vois, tout le monde disparait",
    "Dis @tag, ton père serait pas un voleur? Parce qu'il a volé toutes les étoiles pour les mettre dans tes yeux ✨"
  ],
  ...
  COMMENTAIRES_CERVEAU: [
    ...
    "Avis médical : La zone du sérieux n'a jamais été installée ! 🛠️",
