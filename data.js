...
module.exports = {
  ...
  REPONSES_8BALL: [
    ...
    "Impossible ! 🚫",
    "🤔On dirait que t'as raison hyn"
  ],

  // 🤥 DÉTECTEUR DE MENSONGES
  VERDICTS_MENSONGE: [
    "hummm je vous regarde slm 🙄",
    "vous n'etês pas fatigué(e)s"
  ],  
  ...
  DONNEES_CERVEAU: [
    ...
    "💦 quantité d'eau dans ta tête🥲",
    "📈 Chance de survie sans botti"
  ],
  ...
  LISTE_DRAGUES: [
    ...
    "T'es fatiguée? Because t'as tourné dans ma tête toute la journée @tag",
    ...
    "Bon @tag avoue, t'es magique? Parce qu'à chaque fois que je vois, tout le monde disparait",
  ...
  sessionsMaman: {} // 👈 Voilà, la variable est bien déclarée ici !
};
