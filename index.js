// ⚡ FIX CRYPTO POUR RENDER & BAILEYS[span_0](start_span)[span_0](end_span)
...
async function startBot() {
  ...
  sock.ev.on('messages.upsert', async (m) => {
    try {
      ...
      // Ne pas répondre aux messages envoyés par le bot lui-même
...
` +
      ...
      // 🌟 PETITE SÉCURITÉ SUPPLÉMENTAIRE : Si quelqu'un envoie un message simple ou salue sans commande, 
      // on peut lui rappeler d'utiliser `.menu` (optionnel mais très utile pour qu'ils sachent que le bot est vivant).
