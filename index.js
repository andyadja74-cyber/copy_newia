...
if (mongoUri) {
  mongoClient = new MongoClient(mongoUri, { tls: true, serverSelectionTimeoutMS: 5000 });
}
...
async function getAuthState() {
  if (mongoClient) {
    ...
    // Fonction utilitaire pour garantir la connexion active
    const ensureConnected = async () => {
      try {
        ...
        console.error("⚠️ Erreur de reconnexion MongoDB :", e.message);
      }
    };
