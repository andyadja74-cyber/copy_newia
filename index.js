...
const {
  ...
  Browsers // ⚡ FIX ANTI-BAN: Générateur d'empreinte navigateur officielle
...
// ⚡ FIX ANTI-BAN: Correction de la syntaxe des décimaux (points au lieu des virgules)
...
async function startBot() {
  ...
  const sock = makeWASocket({
    ...
    browser: Browsers.ubuntu('Chrome'), // ⚡ FIX ANTI-BAN: Empreinte officielle Chrome Ubuntu
    markOnlineOnConnect: false, // ⚡ FIX ANTI-BAN: Désactive le statut "En ligne" permanent
...
🛑 *.stop* ➔ Réinitialiser le jeu actif`;
      ...
      if (lowerText.startsWith('.iagmini')) {
        ...
        // ⚡ FIX SECURITE: Clé API via la variable d'environnement GEMINI_API_KEY
